...
public class GeneratorServiceImpl implements GeneratorService {
    ...
    public String createInsuredDetailsUtil(HeaderRequestDTO request) {
        ...
        if (previousTemplateHistory.isPresent()) {
            this.templateHistoryRepository.save(previousTemplateHistory.get().toBuilder()
                            .insuredDetailsRequest(request.toString())
                            .build());
        } else {
    ...
    public String getHeaderTemplateUtil(HeaderRequestDTO request) {
        ...
        if (previousTemplateHistory.isPresent()) {
            this.templateHistoryRepository.save(previousTemplateHistory.get().toBuilder()
                    .partnerDetailsRequest(request.toString())
                    .build());
        } else {
            this.templateHistoryRepository.save(TemplateHistory.builder()
                    .lob(request.getLob())
    ...
    public String getCoverageTemplateUtil(HeaderRequestDTO request) {
        ...
        if (previousTemplateHistory.isPresent()) {
            this.templateHistoryRepository.save(previousTemplateHistory.get().toBuilder()
                    .coverageDetailsRequest(request.toString())
                    .build());
        } else {
            this.templateHistoryRepository.save(TemplateHistory.builder()
                            .lob(request.getLob())
        ...
        String basicCoverageDetails = "<td style=\"text-align:left;width:25%;vertical-align:top;padding-bottom:40px\"><img src=icon_link style=\"height:60px\"><p style=\"margin:2px 0;color:#000;font-size:10px\">description</p><p style=\"margin:0;color:#8a8a8a;font-size:10px\">sub_description</p></td>";
    ...
    public String saveGeneratedHtml(HeaderRequestDTO request) {
        ...
        if (generatedCoi.isPresent()) {
            ...
            GeneratedCoi modifiedCoi = this.generatedCoiRepository.save(generatedCoiFromDB.toBuilder()
                    ...
                    .templateName(request.getTemplateName())
                    .build());
            return staticOne+modifiedCoi.getPartnerDetails()+staticTwo+modifiedCoi.getInsuredDetails()+staticThree+modifiedCoi.getCoverageDetails()+staticFour;
        } else {
